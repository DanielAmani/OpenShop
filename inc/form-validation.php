...
$post_required_element = array('cfg-element-97-7','cfg-element-97-12','cfg-element-97-9','cfg-element-97-13','cfg-element-97-10','cfg-element-97-11');

$post_required_email = array('cfg-element-97-3');

if($_SESSION['captcha_img_string']['d338d5a2c73216e7090b84520b0fe7aec8fd2209'] != $_POST['captcha_input']){$json_error .= '{"element_id":"cfg-element-97-6", "errormessage": "'.addcslashes($contactform_obj->cfg['form_errormessage_captcha'], '"').'", "elementlabel_id": "cfg-element-97-6-label"},';}
